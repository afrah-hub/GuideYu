...
file_path = 'c:/Users/afrah/Documents/SingleProject/GuideYu/src/pages/LessonsScreen.jsx'
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(before + new_return + after)

print('Successfully updated layout via python script')
